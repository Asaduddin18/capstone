let tod = new Date();
let datesssssssss = tod.getDate();
let month = tod.getMonth() + 1; //January is 0 so need to add 1 to make it 1!
let yearrrrrrrrrr = tod.getFullYear();
if (datesssssssss < 10) {
    datesssssssss = '0' + datesssssssss
}
if (month < 10) {
    month = '0' + month
}
maxDate = yearrrrrrrrrr - 18 + '-' + month + '-' + datesssssssss;
minDate = yearrrrrrrrrr - 55 + '-' + month + '-' + datesssssssss;
